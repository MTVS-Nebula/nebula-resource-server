...
import com.nebula.nebula_resource.app.dao.entity.avatar.AvatarTexture;
import java.util.List;
import java.util.Map;

public class AvatarTextureDTO {
    ...
    public AvatarTextureDTO() {
    }

    public AvatarTextureDTO(String settingsName, Map<String, Integer> selectedElements, List<BlendShapeDTO> blendshapes, int minLod, int maxLod, List<Integer> skinColor, List<Integer> eyeColor, List<Integer> hairColor, List<Integer> underpantsColor, List<Integer> teethColor, List<Integer> oralCavityColor, int height, int headSize) {
    ...
    // 반드시 수정해야함.
    public AvatarTextureDTO(AvatarTexture avatarTexture){
        this.settingsName = avatarTexture.getSettingsName();
        this.selectedElements = null;
        this.blendshapes = null;
        this.MaxLod = avatarTexture.getMinLod();
        this.MaxLod = avatarTexture.getMaxLod();
        this.SkinColor = null;
        this.EyeColor = null;
        this.HairColor = null;
        this.UnderpantsColor = null;
        this.TeethColor = null;
        this.OralCavityColor = null;
        this.Height = avatarTexture.getHeight();
        this.HeadSize = this.getHeadSize();
    }
