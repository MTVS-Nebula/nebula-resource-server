...
@Entity
@Table(name = "TBL_AVATAR_EQ", schema = "avatar")
@SequenceGenerator(
        name = "SEQ_AVATAR_EQ_ID_GENERATOR",
        sequenceName = "SEQ_AVATAR_EQ_ID",
        initialValue = 1,
        allocationSize = 1
)
public class AvatarEquipment {
    ...
    @GeneratedValue(
            ...
            generator = "SEQ_AVATAR_EQ_ID_GENERATOR"
    )
    @Column(name = "ID")
    private int id;
    @ManyToOne
    ...
    public AvatarEquipment(int id, Avatar avatar, Clothes clothes, int slotNumber) {
        this.id = id;
        this.avatar = avatar;
